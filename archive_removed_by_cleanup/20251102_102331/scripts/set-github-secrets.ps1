...
$required = @(
  ...
  'AWS_OIDC_ROLE_ARN','AWS_REGION','ECS_CLUSTER_NAME','ECS_SERVICE_NAME_C','ECS_SERVICE_NAME_D',
  'AWS_S3_BUCKET_FRONTEND','AWS_CLOUDFRONT_DISTRIBUTION_ID','AWS_ACCOUNT_ID','ADMIN_DASHBOARD_API_KEY'
)
