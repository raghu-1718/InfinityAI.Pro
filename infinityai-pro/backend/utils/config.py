...
class Config:
    ...
    PERPLEXITY: dict = field(default_factory=lambda: {"api_key": "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", "enabled": True})  # Perplexity for market intelligence
    OPENAI: dict = field(default_factory=lambda: {"api_key": "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", "model": "gpt-3.5-turbo", "enabled": True})  # OpenAI for strategy narration
