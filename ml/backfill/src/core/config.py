...
Per-user credentials stored in Google Cloud Firestore; platform defaults from environment
"""
import os
...
class Config:
    ...
    NOTE: User-specific DhanHQ credentials are stored in Google Cloud Firestore.
