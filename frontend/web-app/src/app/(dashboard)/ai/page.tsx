          ...
          {signalData ? (
              ...
              <Tabs defaultValue="reasoning">
                ...
                <TabsContent value="reasoning" className="mt-4">
                  <Card>
                    <CardHeader>
                      <CardTitle>
                        Why did the AI choose {signalData.signal}?
                      </CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="p-4 bg-secondary/50 rounded-lg border border-border">
                        <p className="leading-relaxed whitespace-pre-wrap">
                          {signalData.market_context?.reasoning ||
                  ...
                  <Card>
                    <CardContent className="pt-6">
                      <p className="text-muted-foreground">
                        Raw technical indicators would be here.
                      </p>
                    </CardContent>
                  </Card>
                </TabsContent>
            ...
            <div className="h-full flex flex-col items-center justify-center p-12 text-center border-2 border-dashed rounded-xl bg-secondary/10">
              ...
              <p className="text-muted-foreground max-w-sm">
                Select a symbol and horizon to generate real-time trading
                signals powered by our Hybrid AI Engine.
              </p>
            </div>
          )}
        </div>
