...
class GeminiModel(Enum):
    ...
    # === GEMINI 3.0 MODELS (Latest - December 2025) ===
    GEMINI_3_PRO = "gemini-3-pro-preview"            # Most advanced, preview version
    GEMINI_3_PRO_IMAGE = "gemini-3-pro-image-preview" # Multimodal with image generation, preview

    # === GEMINI 2.5 MODELS (Production Ready) ===
    GEMINI_25_PRO = "gemini-2.5-pro"                 # Best for complex reasoning, 15 RPM
    GEMINI_25_PRO_EXP = "gemini-2.5-pro-exp"         # Experimental features, 150 RPM
    ...
    GEMINI_25_FLASH_PREVIEW = "gemini-2.5-flash-preview-image"  # Image generation
    ...
    FLASH_LIVE = "gemini-2.0-flash-live"             # Live/streaming API
    ...
    # === SPECIALIZED MODELS ===
    GEMINI_25_PRO_TTS = "gemini-2.5-pro-tts"         # Text-to-speech
    GEMINI_25_FLASH_TTS = "gemini-2.5-flash-tts"     # Fast TTS
    GEMINI_25_FLASH_NATIVE_AUDIO = "gemini-2.5-flash-native-audio-dialog"  # Audio dialog

    # === IMAGE GENERATION (Imagen 4.0) ===
    IMAGEN_4_FAST = "imagen-4.0-fast-generate"       # Fast image generation
    IMAGEN_4_STANDARD = "imagen-4.0-generate"        # Standard quality
