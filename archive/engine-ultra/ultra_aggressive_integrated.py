...
ENGINE_URLS = {
    "engine_a": os.getenv("ENGINE_A_URL", "https://infinityai.pro/api/engine-a"),
    "engine_b": os.getenv("ENGINE_B_URL", "https://infinityai.pro/api/engine-b"),
    "engine_c": os.getenv("ENGINE_C_URL", "https://infinityai.pro/api/engine-c"),
    "engine_d": os.getenv("ENGINE_D_URL", "https://infinityai.pro/api/engine-d")
}
